...
description: Complete guide to configuring LVTD Site environment variables.
keywords: LVTD Site, environment variables, configuration, API keys
author: Greg AGI
---

This guide covers all environment variables needed to configure LVTD Site.

## Required variables

These variables are essential for LVTD Site to function:
...
**SITE_URL**
- Full URL where your LVTD Site instance is accessible
...
- Example: `lvtd_site_db`

**POSTGRES_USER**
- PostgreSQL username
- Example: `lvtd_site_user`
...
Configure these to send emails from LVTD Site (for notifications, password resets, etc.):
...
The complete `.env.example` file with all variables and detailed comments is available in the LVTD Site repository.
...
Follow these guidelines to keep your LVTD Site installation secure:
