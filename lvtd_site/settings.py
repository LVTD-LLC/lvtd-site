"""
Django settings for lvtd_site project.
...
import logfire
from lvtd_site.logging_utils import scrubbing_callback
...
WSGI_APPLICATION = "lvtd_site.wsgi.application"
...
folder_name = f"lvtd_site-{ENVIRONMENT}"
...
ACCOUNT_ADAPTER = "lvtd_site.adapters.CustomAccountAdapter"
if ENVIRONMENT != "dev":
    ACCOUNT_DEFAULT_HTTP_PROTOCOL = "https"

SOCIALACCOUNT_AUTO_SIGNUP = True
SOCIALACCOUNT_PROVIDERS = {}
SOCIALACCOUNT_ADAPTER = "lvtd_site.adapters.CustomSocialAccountAdapter"
...
ANYMAIL = {
    ...
    "MAILGUN_SENDER_DOMAIN": "mg.lvtd_site.app",
}
DEFAULT_FROM_EMAIL = "Greg AGI from LVTD Site <hello@lvtd_site.app>"
SERVER_EMAIL = "LVTD Site Errors <error@lvtd_site.app>"
...
if ENVIRONMENT == "prod":
    ...
    LOGGING["loggers"]["lvtd_site"]["level"] = env("DJANGO_LOG_LEVEL", default="INFO")
    LOGGING["loggers"]["lvtd_site"]["handlers"].append("json_console")
